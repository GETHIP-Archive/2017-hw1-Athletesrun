function problemOne() {
  ...
  var average = (num1 + num2 + num3 + num4 + num5) / 6;
...
function problemTwo() {
  ...
  let num1 = document.getElementById('grade1').value;
  let num2 = document.getElementById('grade2').value;
  let num3 = document.getElementById('grade3').value;
  let num4 = document.getElementById('grade4').value;
  let num5 = document.getElementById('grade5').value;
  let num6 = document.getElementById('grade6').value;

  //Compute the GPA.

  var gpa = findGPA(num1, num2, num3, num4, num5, num6);
